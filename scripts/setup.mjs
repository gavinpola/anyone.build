...
console.log(`
anyone.build — launch checklist
================================
You (accounts, money):
  1. Buy anyone.build (Porkbun). Point it at Vercel.
