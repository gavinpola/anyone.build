...
const faq: Array<[string, string]> = [
  ...
  ["How do I change something?", "Hold ⇧⌘ (⇧Ctrl on Windows) and click anything on the wall, or the empty wall itself. Say what should change. Sign in with GitHub the first time."],
