...
/** Who's here, as an avatar stack: the people whose cursors are on the wall, then +N for the rest. Never more bubbles than the count says. */
export function PresenceStack() {
  ...
  const rest = Math.max(0, others - shown.length);
