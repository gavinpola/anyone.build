...
- [x] **Model routing by scope.** tiny/small → deepseek-v4-flash (and the fast path); medium → qwen3-coder-plus; large (a proposal that won the daily vote, ≤1/day) → claude-sonnet-5. Per-build caps unchanged; three levers on /admin.
