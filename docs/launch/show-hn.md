...
Since Thursday: 73 asks, 24 live, 36 rejected, 15 failed; 1,541 lines written by the agent; median build three minutes. The 24 live changes cost 75¢ of model, the 14 failures 89¢. Someone asked for "gta6 but in the browser" and got a 340-line driving game for 6¢.
