...
export const backendRules = {
  ...
  "no-restricted-syntax": [
    ...
    { selector: "MemberExpression[computed=true][property.value=/^(constructor|prototype|__proto__)$/]", message: "Computed access to constructor/prototype is banned in room functions (realm escape)." },
    { selector: "MemberExpression[computed=true][property.type='BinaryExpression']", message: "Computed member access with a built-up string key is banned in room functions (obfuscation)." },
    { selector: "MemberExpression[computed=true][property.type='TemplateLiteral']", message: "Computed member access with a template-literal key is banned in room functions (obfuscation)." },
